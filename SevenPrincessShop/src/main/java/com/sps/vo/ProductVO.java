...
public class ProductVO {
	...
	private int product_subCategory;		// 상품 카테고리 별 상세 이미지 구별 변수(추가)
	...
	public ProductVO(int product_idx, String product_name, int product_price, int product_category,
			int product_subCategory, String product_registerDate, int product_hit, int product_stock,
			String product_imgPath, int product_imgPathStock) {
		super();
	...
	public void setProduct_subCategory(int product_subCategory) {
		this.product_subCategory = product_subCategory;
	}
