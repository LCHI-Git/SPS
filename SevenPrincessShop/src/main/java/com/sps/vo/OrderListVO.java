...
public class OrderListVO {
	...
	public OrderListVO() {	}
	public OrderListVO(int orderList_idx, int orderList_client_idx, int orderList_client_name,
			int orderList_product_idx, int orderList_product_name, String orderList_address,
			String orderList_detailAddress, String orderList_status, String orderList_size, String orderList_color,
			String orderList_stock, String orderList_orderDate) {
		super();
	...
	public OrderListVO(int orderList_client_idx, int orderList_product_idx, String orderList_size,
