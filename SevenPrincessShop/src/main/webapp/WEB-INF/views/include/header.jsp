...
<div class="topBar">
	<ul class="topBarMenu pull-right">
		...
		<li><a href="/member/join" style="position:relative">JOIN</a></li>
...
<div class="col-xs-12 topArea">
	<div class="contentLimit">
		<div class="col-xs-12 col-lg-8 col-lg-offset-2 ">
			...
			<center>
				<a class="" href="/"><img src="./images/icon/mainLogoWhite.PNG"></a>
			</center>
			</div>
					...
					<div class="input-group input-group-sm searchArea">						
						<input type="text" name="key" id="key" class="form-control" value="" placeholder="Search for...">
							<span class="input-group-btn">
								<button class="btn"><img src="./images/icon/search.PNG"></button>
							</span>
					</div>
				</form>
			</div>
